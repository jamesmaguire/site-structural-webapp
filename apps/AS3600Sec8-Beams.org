#+title: Beam design
#+subtitle: to AS3600-2018(+A2) Section 8
...
Capacity reduction factor, \Phi {{{span(o_phi)}}}  {{{ref(Table 2.2.2)}}}
...
Nominal max agg. size, d_g {{{input(i_dg,20,mm)}}} {{{ref(Section 8.2.4.2.1)}}}

Aggregate size factor, k_{dg} {{{output(o_kdg)}}} {{{ref(Equation 8.2.4.2(3))}}}

Longitudinal strain, \epsilon_x {{{span(o_epsilonx)}}} {{{ref(Section 8.2.4.2.2)}}}

Inclination of compr. strut, \theta_v {{{span(o_thetav)}}} {{{ref(Equation 8.2.4.2(1))}}}
...
Capacity reduction factor, \Phi {{{span(o_phiV)}}} {{{ref(Table 2.2.2)}}}
